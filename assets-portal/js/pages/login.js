...
let login_intro = `
    <h1>Welcome to the new <span class="nowrap">Generic Church</span> Portal</h1>
    <p>
      ...
      Thank you so much for helping us make this transition and furthering the mission of Generic Church Church. If you have questions or need assistance, please contact us by sending an email to <a href="mailto:giving@faithpromise.org">giving@faithpromise.org</a>.
    </p>
`;
